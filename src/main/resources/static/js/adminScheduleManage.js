...
$(document).ready(function() {
    ...
    function checkInput(inputForm){
        if (inputForm.startTime==null || inputForm.startTime=="")
        {
            alert("起始时间未填写！");
            return false;
        }
        else if (inputForm.endTime==null || inputForm.endTime=="")
        {
            alert("结束时间未填写！");
            return false;
        }
        else if (inputForm.fare==null || inputForm.fare=="")
        {
            alert("票价未填写！");
            return false;
        }
