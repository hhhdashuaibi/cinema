...
$(document).ready(function () {
    ...
    $('#VIPKind-edit-form-btn').click(function () {
        var form = {
            name:VIPname,
            newname: $("#VIPKind-edit-name-input").val(),
        ...
        postRequest(
            '/vip/updateVIPCard?kind='+VIPname+'&targetAmount='+$("#VIPKind-edit-target-input").val()+'&discountAmount='+$("#VIPKind-edit-give-input").val()+'&newkind='+$("#VIPKind-edit-name-input").val(),
            null,
            function (res) {
                if(res.success){
